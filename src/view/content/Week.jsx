    ...
    return (
        <>
            <div className="row tab-week" >
                <div className="tab-week__item tab-week__item--active col zoom-in">
                    <div className="week">
                        <div className="week-header">
                            <div className="week-header__day">Thursday</div>
                            <div className="week-header__date">31 - 03 - 2022</div>
                        </div>
                        <div className="week-content">
                            <div className="week-content__img"><img src="http://openweathermap.org/img/wn/10d@2x.png" alt="icon" className="week-weather-img" /></div>
                            <div className="week-content__deg">21.7°C <br />
                                30.12°C</div>
                        </div>
                    </div>
                </div>

                <div className="tab-week__item col zoom-in">
                    <div className="week">
                        <div className="week-header">
                            <div className="week-header__day">Thursday</div>
                            <div className="week-header__date">31 - 03 - 2022</div>
                    ...
                    <div className="week-picked__content col">
                        <div className="week-picked__logo">
                            <svg stroke="currentColor" fill="currentColor" strokeWidth="0" viewBox="0 0 24 24"
                                className="w-full h-full" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg">
                                <g>
